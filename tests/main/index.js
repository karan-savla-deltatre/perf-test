...
export const options = {
    ...
    thresholds: {
        ...
        "AFC CUP": ['p(95)<7000'],
        "DAPI DV": ['p(95)<1550'],
        "DAPI Stories": ['p(95)<1550'],
        "Fixtures Trend": ['p(95)<5000'],
...
export default function() {
    ...
    group('New Fixtures Endpoints', () => {
        ...
        FixturesData.add(respCLFixtures.body.length / 1024);
    ...
    group('Fixtures Endpoints', () => {
        ...
        OldFixturesData.add(respCLFixtures.body.length / 1024);
    ...
    group('AFC HP Endpoints', () => {
        ...
        HPData.add(respHP.body.length / 1024);
    ...
    group('DAPI Endpoints', () => {
        ...
        DSData.add(respDS.body.length / 1024);
        DDData.add(respDV.body.length / 1024);
    ...
    group('Competition HP Endpoints', () => {
        ...
        CLData.add(respCL.body.length / 1024);
        CUPData.add(respCL.body.length / 1024);
